...
class ControllerExtensionShippingups extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_ups_cost'])) {
			$data['shipping_ups_cost'] = $this->request->post['shipping_ups_cost'];
		} else {
			$data['shipping_ups_cost'] = $this->config->get('shipping_ups_cost');
		}
