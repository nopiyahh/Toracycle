...
class ControllerExtensionShippingFedex extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_fedex_cost'])) {
			$data['shipping_fedex_cost'] = $this->request->post['shipping_fedex_cost'];
		} else {
			$data['shipping_fedex_cost'] = $this->config->get('shipping_fedex_cost');
		}
