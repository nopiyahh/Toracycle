...
class ControllerExtensionShippingDhl extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_dhl_cost'])) {
			$data['shipping_dhl_cost'] = $this->request->post['shipping_dhl_cost'];
		} else {
			$data['shipping_dhl_cost'] = $this->config->get('shipping_dhl_cost');
		}

		if (isset($this->request->post['shipping_dhl_tax_class_id'])) {
			$data['shipping_dhl_tax_class_id'] = $this->request->post['shipping_dhl_tax_class_id'];
		} else {
			$data['shipping_dhl_tax_class_id'] = $this->config->get('shipping_dhl_tax_class_id');
		}
