...
/* extension/shipping/dhl.twig */
class __TwigTemplate_2c680e2f7e15010e4cd9b362c962df8c346c8476138fb15cba6bebb2e4beee9c extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\">
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <input type=\"text\" name=\"shipping_dhl_cost\" value=\"";
        // line 31
        echo ($context["shipping_dhl_cost"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_cost"] ?? null);
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <select name=\"shipping_dhl_tax_class_id\" id=\"input-tax-class\" class=\"form-control\">
                <option value=\"0\">";
        // line 38
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tax_class"]) {
            // line 40
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["tax_class"], "tax_class_id", [], "any", false, false, false, 40) == ($context["shipping_dhl_tax_class_id"] ?? null))) {
                // line 41
                echo "                <option value=\"";
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <select name=\"shipping_dhl_geo_zone_id\" id=\"input-geo-zone\" class=\"form-control\">
                <option value=\"0\">";
        // line 53
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["geo_zone"]) {
            // line 55
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 55) == ($context["shipping_dhl_geo_zone_id"] ?? null))) {
                // line 56
                echo "                <option value=\"";
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <select name=\"shipping_dhl_status\" id=\"input-status\" class=\"form-control\">
                ";
        // line 68
        if (($context["shipping_dhl_status"] ?? null)) {
            // line 69
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <input type=\"text\" name=\"shipping_dhl_sort_order\" value=\"";
        // line 81
        echo ($context["shipping_dhl_sort_order"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_sort_order"] ?? null);
...
";
    ...
    {
        return "extension/shipping/dhl.twig";
    }
    ...
    {
        return new Source("", "extension/shipping/dhl.twig", "");
    }
}
